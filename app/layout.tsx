...
import { Dancing_Script, Caveat, Noto_Sans_Arabic } from "next/font/google"
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      <body className={`font-sans antialiased ${dancingScript.variable} ${caveat.variable} ${notoSansArabic.variable}`}>
        <LanguageProvider>
