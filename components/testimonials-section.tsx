...
export function TestimonialsSection() {
  ...
  return (
    <section
      id="testimonials"
      ref={sectionRef}
      className={`relative pt-16 pb-16 px-4 sm:px-6 lg:px-8 ${isRTL ? "text-right" : ""}`}
    >
      {/* Grid Background */}
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 md:mb-32">
          <div
            className={`fade-in-element opacity-0 translate-y-8 transition-all duration-1000 ease-out inline-flex items-center gap-2 text-white/60 text-sm font-medium tracking-wider uppercase mb-6 ${isRTL ? "flex-row-reverse" : ""}`}
          >
